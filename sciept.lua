  ...
  features = { -- features = Active script functions, you can turn them off by deleting any function, e.g. “mailing”.
    ...
    mail = { -- Automatic dispatch of your pets \ items 
        items = {
            ...
            ["Exotic Mining Chest"] = 25,  -- count to send item from
            ["Runic Mining Chest"] = 5,  -- count to send item from
            ["Crystal Key"] = 1,  -- count to send item from
            ["Crystal Key Lower Half"] = 5,  -- count to send item from
            ["Crystal Key Upper Half"] = 1,  -- count to send item from
            ["Instant Luck Potion IV"] = 10,  -- count to send item from
            ["Mastery XP Potion"] = 1,  -- count to send item from
            ["Huge Egg"] = 1,  -- count to send item from
            ["Abyssal Treasure Chest"] = 10,  -- count to send item from
            ["Metal Detector"] = 3,  -- count to send item from
            ["Exotic Fishing Chest"] = 15,  -- count to send item from
            ["Legendary Mining Chest"] = 20,  -- count to send item from
            ["Legendary Fishing Chest"] = 20,  -- count to send item from
    ...
    webhook = {
        ...
        difficultyToSend = 1000000000 -- pets difficulty
    },
